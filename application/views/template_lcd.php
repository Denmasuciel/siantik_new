...
<head>
   ...
   <script type="text/javascript" src="<?= base_url('media/time.js'); ?>"></script>
...
<body>
   ...
   <div class="container" id="container">
      ...
      <!-- header -->
      <header>
         <nav class="navbar navbar-light  " style="background-color: #3D94FF;">
            ...
            <div class="navbar-header">
               ...
               <span class="navbar-brand">
                  ...
                  <small><b> SIANTIK (Sistem Antrian Apotik)</b></small>
               </span>
            </div>
            <ul class="nav navbar-nav navbar-right">
               <!-- <li><a href="#"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li> -->
               <li>
               <h3><span id="dates"><span id="the-day">Hari, 00 Bulan 0000</span>
  							<b><span id="the-time">00:00:00</span> </span></b></h3>
               </li>
            </ul>
      ...
      <footer style="background-color: #3D94FF;">
         <marquee>
            <h4>
               <?php
               foreach ($pengumuman2  as $key) {
                  echo $key['konten'];
                  echo '&nbsp;&nbsp;&nbsp;&nbsp;';
               }
               // echo $pengumuman['konten'];
               ?>
            </h4>
         </marquee>
      </footer>
